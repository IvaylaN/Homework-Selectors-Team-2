...
public class homeworkIvayla {
    ...
    public void loginTest() {
        ...
        System.out.println("8. Check number of profile personal posts");
        WebElement porfilePosts = driver.findElement(By.id("nav-link-profile"));
        porfilePosts.click();
        List<WebElement> personalPosts = driver.findElements(By.xpath("//*[@class='post-img']"));
        System.out.println("The number of personal posts is: " + posts.size());
    }
